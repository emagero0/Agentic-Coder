...
| `feedback-loop.md` | Agent feedback loop protocol | ⭐⭐⭐⭐ | ALL executions — pre-load rules, post-record errors |
| `content-humanizer.md` | Content humanizer policy | ⭐⭐⭐⭐ | Content generation for human readers |
